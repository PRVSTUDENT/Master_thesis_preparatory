...
R4H and R4I-R show that long-replay/deck-clone restart records are clean on the confirmed 250 branch, while generated short-source decks remain non-equivalent even with post-target buffering. Deck-clone/truncate is confirmed for 250--270--500 and 250--280--500. The 505--750 branch remains scientifically unclassified because the available attempts failed during scratch restart-file writing. Do not submit R4J9/R4J10 yet. Run R4K1 on the confirmed 250 branch and use R4K2 preflight to decide whether the 505 branch can proceed or must be redesigned.
