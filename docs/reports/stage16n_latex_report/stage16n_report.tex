...
The R4F controls were submitted on 2026-06-16 after merging the prepared files into \code{copilot/curved-cephalopod}. R4F1 is PBS job \code{1347842.mmaster02}, running on \code{mnode101}; R4F2 is PBS job \code{1347843.mmaster02}, running on \code{mnode102}. These jobs should be classified before R4J9/R4J10 are considered.
