...
To avoid repeating the HPC \code{/home} storage issue, the R4J pair is submitted through the scratch watchdog \code{watch\_cleanup\_and\_submit\_stage16n\_scratch\_jobs.sh}. This script waits for ongoing offload work to finish, verifies \code{/home} and \code{/scratch} usage, checks that no large Abaqus heavy files remain in the \code{/home} project tree, stages a lightweight repository-shaped tree to \code{/scratch/pr21vyci/stage16n\_scratch\_runs/Abaqus\_trial}, submits both jobs from the scratch case directories, and copies back only lightweight evidence. It was started on the HPC at Fri Jun 12 12:24:22 CEST 2026 as PID 2444124 and initially waited because offload PID 2397333 was still copying the R3J5/R3J6 \code{.stt} files.
