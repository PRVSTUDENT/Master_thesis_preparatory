...
The current operational conclusion after R4K2B is that the 250 branch is validated and ready for a storage-light true-jump controller after the next storage/resource gate, while the 505 branch needs audit or redesign. The preserved R4E2 cycle-505 source should not be treated as a valid continuation source. R4J9/R4J10 and any broad true-jump batch remain blocked.
