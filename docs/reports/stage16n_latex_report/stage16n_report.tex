...
To avoid idle queue time while preserving restart-source order, R4Q4--R4Q7 were submitted as a held dependent chain rather than concurrent jobs. R4Q4 \code{1362637.mmaster02} depends on \code{afterok:1362636.mmaster02} and targets source1000 \(\rightarrow\) target1021, solve 1022--1250. R4Q5 \code{1362638.mmaster02} depends on R4Q4 and targets source1250 \(\rightarrow\) target1271, solve 1272--1500. R4Q6 \code{1362639.mmaster02} depends on R4Q5 and targets source1500 \(\rightarrow\) target1521, solve 1522--1750. R4Q7 \code{1362640.mmaster02} depends on R4Q6 and targets source1750 \(\rightarrow\) target1771, solve 1772--2000. Each controller self-gates at runtime by checking the predecessor status and block summary, confirming required heavy source files, parsing the restart step and increment from the predecessor \code{.sta}, and exiting before Abaqus if the predecessor failed or comparison blocked continuation. R4Q7 stops at cycle2000; no jobs beyond cycle2000 are queued.
