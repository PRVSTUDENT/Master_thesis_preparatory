...
The recovery files were committed as \code{388cf72} and pulled into the HPC scratch clone before submission. The storage gate passed on 2026-06-20 at 06:55 CEST, reporting \code{/home/pr21vyci} at 66G and no large Abaqus files in the home project. The first two recovery cases were submitted through the guarded Abaqus wrapper on 2026-06-20 at 06:56 CEST: R4I-R1 as \code{1350597.mmaster02} and R4I-R2 as \code{1350598.mmaster02}. Both requested one node with 16 cores, 90 GB, and 24 h, and were queued after submission. R4I-R3 and R4I-R4 remain held for the second wave so the Stage 16N policy of at most two simultaneous 16-core Abaqus jobs is not exceeded.
