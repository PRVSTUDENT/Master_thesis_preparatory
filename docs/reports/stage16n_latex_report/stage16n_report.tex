...
The current operational conclusion after R4N is that the 250 branch has a storage-light source-regeneration pattern and a passed target-270 true-jump gate, but target 275 is not yet validated. The 505 branch is parked until a new exact-control gate or redesign is defined. The preserved R4E2 cycle-505 source should not be treated as a valid continuation source. R4J9/R4J10, target 280/285 progression, and any broad true-jump batch remain blocked until the target-275 review signature is diagnosed or a new gated controller is explicitly defined.
