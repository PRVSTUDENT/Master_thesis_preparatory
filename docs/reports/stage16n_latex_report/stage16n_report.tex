...
\begin{enumerate}
  \item Prepare and submit \code{B1\_100\_to\_125\_to\_250} on HPC using the locked 16-CPU production policy.
  \item Compare the fixed-jump result against the 1000-cycle reference and against the B0-1 reinjection baseline.
  \item Keep \code{SDV8} as a diagnostic warning metric, not a hard pass/fail metric.
  \item If the first case is acceptable, expand to larger fixed state-initialized jumps.
\end{enumerate}
