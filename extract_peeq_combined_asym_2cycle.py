...
odb_path = r"D:\TUBAF\Master_Thesis\Abaqus_trial\combined_asym_2cycle.odb"
step_name = "Step-1"
...
csv_path = os.path.join(base, "combined_asym_2cycle_peeq.csv")
png_path = os.path.join(base, "combined_asym_2cycle_peeq.png")
...
plt.title("Asymmetric combined hardening: PEEQ vs time")
plt.grid(True)
plt.tight_layout()
