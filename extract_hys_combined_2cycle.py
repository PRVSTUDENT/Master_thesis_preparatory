...
odb_path = r'D:\TUBAF\Master_Thesis\Abaqus_trial\combined_2cycle.odb'
step_name = 'Step-1'
right_node_for_u = 13
...
csv_path = os.path.join(base, 'combined_2cycle_hys.csv')
png_path = os.path.join(base, 'combined_2cycle_hys.png')
...
plt.title('Combined hardening: 2 cycles')
plt.grid(True)
plt.tight_layout()
