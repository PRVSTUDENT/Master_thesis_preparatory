...
odb_path = r'D:\TUBAF\Master_Thesis\Abaqus_trial\combined_2cycle_tuned.odb'
step_name = 'Step-1'
right_node_for_u = 13
...
csv_path = os.path.join(base, 'combined_2cycle_tuned_hys.csv')
png_path = os.path.join(base, 'combined_2cycle_tuned_hys.png')
...
plt.title('Combined hardening tuned: 2 cycles')
plt.grid(True)
plt.tight_layout()
