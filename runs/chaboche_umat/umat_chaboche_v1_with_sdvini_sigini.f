...
C     Exact cycle-19 averaged stress extracted from ODB (May 9, 2026)
C     Source: stage4_injected_cycle_jump/cycle19_exact_stress_for_injection.csv

      IF (NTENS.GE.1) SIGMA(1) = 335.5768737792969D0
      IF (NTENS.GE.2) SIGMA(2) = 0.0D0
      IF (NTENS.GE.3) SIGMA(3) = 0.0D0
      IF (NTENS.GE.4) SIGMA(4) = 0.0D0
      IF (NTENS.GE.5) SIGMA(5) = 0.0D0
      IF (NTENS.GE.6) SIGMA(6) = 0.0D0
