...
options = {
    ...
    'input':'chaboche_stage4b_cycle19_exact_to_cycle20_statev_only_debug',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'chaboche_stage4b_statev_only_debug_check',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
    'user':'umat_chaboche_v1_with_sdvini_debug.f',
    'visco':OFF,
    'xplSelect':OFF,
}
