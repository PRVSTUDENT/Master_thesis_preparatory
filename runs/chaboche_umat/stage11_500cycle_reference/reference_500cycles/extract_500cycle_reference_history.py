...
ODB_PATH = "chaboche_vp_v1_cyclic_eps005_500cycles.odb"
OUT_CSV = "chaboche_vp_v1_cyclic_eps005_500cycles_cycle_history.csv"

NSTATEV = 15
STRESS_COMPONENTS = ["S11", "S22", "S33", "S12", "S13", "S23"]
TARGET_CYCLES = list(range(1, 501))
...
def main():
    ...
    print("Cycle 500 frame time:", rows[-1]["frame_time"])
    print("Cycle 500 frame time error:", rows[-1]["frame_time_error"])
    print("Cycle 500 STATEV1:", rows[-1]["STATEV1_end"])
    print("Cycle 500 S11:", rows[-1]["S11"])
    print("Cycle 500 RIGHT_FACE_RF1_SUM:", rows[-1]["RIGHT_FACE_RF1_SUM"])
