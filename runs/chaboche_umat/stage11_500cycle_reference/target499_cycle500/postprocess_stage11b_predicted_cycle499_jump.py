...
EXPECTED_INITIAL_STATEV1 = 3.5839592614213402
EXPECTED_INITIAL_S11 = 493.4802449549474
...
def collect_interpolated_reference():
    ...
    try:
        ...
        ref = {
            "source": "linear_interpolation_between_bracketing_500cycle_ODB_frames",
            "lower_time": lower[0],
            "upper_time": upper[0],
            "alpha": alpha,
...
def write_report(rows, reference):
    ...
    lines = [
        ...
        "- Stage 11B DeltaN_test = 489 accepted: `%s`" % ("yes" if outcome.startswith("accepted") else "no"),
