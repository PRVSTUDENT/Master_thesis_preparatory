...
- Case: `B3_500_to_575_to_750`
- Job: `stage16n_fixed_b3_500_to_575_to_750`
- Base cycle state: `500`
- Interpreted jump target cycle: `575`
- Compare cycle: `750`
- Skipped cycles: `75`
- Continued cycles in Abaqus deck: `175`
- State strategy: `zero_order_hold_from_base_cycle`
- Source state CSV: `stage16n_exact_state_cycle0500.csv`
- Source state binary: `stage16n_exact_state_cycle0500.bin`
- UMAT with reader hooks: `stage16n_sdvini_sigini_state_reader.for`
- PBS submit script: `submit_stage16n_fixed_b3_500_to_575_to_750.pbs`
- Nodes: `6642`
- Elements: `3148`
