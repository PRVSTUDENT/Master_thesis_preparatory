...
OLDJOB="stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281"
...
echo "[Stage16N-R4H] case: R4H2_source_250_to_281_restart_280_to_500"
...
if [[ ! -f "stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.odb" ]]; then
  abaqus job="stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281" input="stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.inp" oldjob="$BASE_OLDJOB" \
    ...
    2>&1 | tee "$LOG_DIR/stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.log"
fi

if [[ ! -f "stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.sta" ]] || ! grep -q "THE ANALYSIS HAS COMPLETED SUCCESSFULLY" "stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.sta"; then
  echo "Source split solve did not complete successfully; check stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.sta" >&2
  exit 2
fi

RESTART_INC="$(awk -v step="$RESTART_CYCLE" '$1 == step && $2 ~ /^[0-9]+$/ {inc=$2} END {if (inc == "") exit 3; print inc}' "stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281.sta")"
python3 - <<PY
from pathlib import Path
text = Path("stage16n_r4h2_source_250_to_281_restart_280_to_500.inp").read_text()
Path("stage16n_r4h2_source_250_to_281_restart_280_to_500.inp").write_text(text.replace("INC=__R4H_RESTART_INC__", "INC=" + "$RESTART_INC"))
PY

abaqus python stage16n_extract_hysteresis_and_local_states.py --job "stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281" \
  2>&1 | tee "$LOG_DIR/stage16n_r4h2_source_250_to_281_restart_280_to_500_source_250_to_281_extract.log" || true
...

{
  ...
  echo "- Case: \`R4H2_source_250_to_281_restart_280_to_500\`"
  echo "- Mode: \`$MODE\`"
