...
OLDJOB="stage16n_r4g4_split_250_to_270_to_500_source_250_to_270"
MODE="source_split"
...
echo "[Stage16N-R4G] case: R4G4_split_250_to_270_to_500"
...
if [[ ! -f "stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.odb" ]]; then
  abaqus job="stage16n_r4g4_split_250_to_270_to_500_source_250_to_270" input="stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.inp" oldjob="$BASE_OLDJOB" \
    ...
    2>&1 | tee "$LOG_DIR/stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.log"
fi

if [[ ! -f "stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.sta" ]] || ! grep -q "THE ANALYSIS HAS COMPLETED SUCCESSFULLY" "stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.sta"; then
  echo "Source split solve did not complete successfully; check stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.sta" >&2
  exit 2
fi

RESTART_INC="$(awk -v step="$RESTART_CYCLE" '$1 == step && $2 ~ /^[0-9]+$/ {inc=$2} END {if (inc == "") exit 3; print inc}' "stage16n_r4g4_split_250_to_270_to_500_source_250_to_270.sta")"
python3 - <<PY
from pathlib import Path
text = Path("stage16n_r4g4_split_250_to_270_to_500.inp").read_text()
Path("stage16n_r4g4_split_250_to_270_to_500.inp").write_text(text.replace("INC=__R4G_RESTART_INC__", "INC=" + "$RESTART_INC"))
PY
...

{
  ...
  echo "- Case: \`R4G4_split_250_to_270_to_500\`"
  echo "- Mode: \`$MODE\`"
