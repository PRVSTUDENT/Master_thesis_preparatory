C ======================================================================
C STAGE16N_RESTART_JUMP_DEBUG_UMAT.FOR
C
C Abaqus UMAT for Stage 16N-R3 restart debug smoke tests.
C
...
C ======================================================================
     ...
     4 NOEL,NPT,LAYER,KSPT,JSTEP,KINC)
      ...
      IF (DBG_COUNT.LT.64) THEN
        IF ((NOEL.LE.4 .AND. NPT.LE.2) .OR.
     1      DBG_COUNT.LT.8) THEN
          DBG_COUNT=DBG_COUNT+1
          WRITE(6,*) 'STAGE16N_R3_DEBUG_TRACE',
...
C Empty initialization hooks. Controlled state injection will replace these
C later with generated per-element/per-integration-point values.
