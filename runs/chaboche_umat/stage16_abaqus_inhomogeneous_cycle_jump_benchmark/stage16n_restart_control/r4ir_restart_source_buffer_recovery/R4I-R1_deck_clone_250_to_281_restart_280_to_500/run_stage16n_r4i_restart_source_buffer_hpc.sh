...
SOURCE_JOB="stage16n_r4ir1_deck_clone_250_to_281_restart_280_to_500_source_250_to_281"
...
path = Path("stage16n_r4ir1_deck_clone_250_to_281_restart_280_to_500.inp")
