...
echo "[Stage16N-R3J] solved continuation cycles: 511 -> $TARGET_CYCLE"
...
CASE_DIR="runs/chaboche_umat/stage16_abaqus_inhomogeneous_cycle_jump_benchmark/stage16n_restart_control/restart_jump_cases/R4J6_500_to_510_solve_511_to_750"
