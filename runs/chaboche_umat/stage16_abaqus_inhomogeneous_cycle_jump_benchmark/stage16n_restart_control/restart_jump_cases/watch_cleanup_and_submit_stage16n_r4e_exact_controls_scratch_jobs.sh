...
# Stage and submit the R4E exact-target true-skip diagnostic pair from scratch.
...
CASE1_NAME="R4E1_250_to_280_exact_solve_281_to_500"
CASE2_NAME="R4E2_500_to_505_exact_solve_506_to_750"

SCRATCH_ROOT="/scratch/$USER_NAME/stage16n_scratch_runs_r4e_exact_controls"
