...
** Stage 16N-R4F continuation: R4F1_250_to_280_fullrestart_solve_281_to_500
** Full native restart from target cycle; no SDVINI/SIGINI and no UMAT overwrite.
*HEADING
Stage 16N-R4F continuation 280 to 500
...
CASE_DIR="runs/chaboche_umat/stage16_abaqus_inhomogeneous_cycle_jump_benchmark/stage16n_restart_control/full_target_restart_cases/R4F1_250_to_280_fullrestart_solve_281_to_500"
