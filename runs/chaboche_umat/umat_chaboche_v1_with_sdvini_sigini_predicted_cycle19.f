...
C ======================================================================
C SIGINI: Initialize residual stress from extracted cycle-19 data.
C ======================================================================
...
C     Predicted cycle-19 stress prepared from cycle-10 state (Stage 5A)
C     Source: stage5_predicted_cycle_jump/cycle19_predicted_stress_for_injection.csv

      IF (NTENS.GE.1) SIGMA(1) = 339.014099121D0
      IF (NTENS.GE.2) SIGMA(2) = -1.42108547152D-14
      IF (NTENS.GE.3) SIGMA(3) = -1.50990331349D-14
      IF (NTENS.GE.4) SIGMA(4) = 3.87337054501D-14
      IF (NTENS.GE.5) SIGMA(5) = -1.20852815838D-14
      IF (NTENS.GE.6) SIGMA(6) = 1.04574270107D-14
...
C     Predicted cycle-19 state prepared from cycle-10 state (Stage 5A)
C     Source: stage5_predicted_cycle_jump/cycle19_predicted_statev_for_injection.csv

      STATEV(1)  = 0.134935969953D0       ! STATEV1: accumulated viscoplastic strain
      STATEV(2)  = -84.2407455444D0       ! STATEV2: backstress X1
      STATEV(3)  = 42.1203727722D0        ! STATEV3: backstress X2
      STATEV(4)  = 42.1203727722D0        ! STATEV4: backstress X3
      STATEV(5)  = 3.56155496981D-15      ! STATEV5: near-zero shear component
      STATEV(6)  = 1.8035946529D-15       ! STATEV6: near-zero shear component
      STATEV(7)  = -1.59588153772D-15     ! STATEV7: near-zero shear component
      STATEV(8)  = -0.00180919677951D0    ! STATEV8: viscoplastic strain Ep1
      STATEV(9)  = 0.000904598389752D0    ! STATEV9: viscoplastic strain Ep2
      STATEV(10) = 0.000904598389752D0    ! STATEV10: viscoplastic strain Ep3
      STATEV(11) = -5.38579218827D-19     ! STATEV11: near-zero shear component
      STATEV(12) = -3.23555712142D-19     ! STATEV12: near-zero shear component
      STATEV(13) = -5.91050030116D-20     ! STATEV13: near-zero shear component
      STATEV(14) = 1.34481799027D0        ! STATEV14: recomputed isotropic hardening
