...
HISTORY_CSV = ROOT / "chaboche_v1_full_statev_cycle_history_exact.csv"
STABILITY_CSV = ROOT / "chaboche_v1_full_statev_cycle_stability_exact.csv"

PREDICTIONS_CSV = ROOT / "chaboche_v1_vector_statev_cycle_jump_predictions_exact.csv"
ERRORS_CSV = ROOT / "chaboche_v1_vector_statev_cycle_jump_errors_exact.csv"
CONTROL_CSV = ROOT / "chaboche_v1_vector_statev_adaptive_jump_control_exact.csv"
REPORT = ROOT / "CHABOCHE_V1_VECTOR_STATEV_CYCLE_JUMP_REPORT_EXACT.md"
...
def main():
    ...
    print("Vector STATEV cycle-jump analyzer (exact) complete")
