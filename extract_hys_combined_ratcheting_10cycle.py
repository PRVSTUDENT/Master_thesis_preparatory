...
csv_path = os.path.join(base, 'combined_ratcheting_10cycle_hys.csv')
png_path = os.path.join(base, 'combined_ratcheting_10cycle_hys.png')
...
plt.title('Combined hardening ratcheting-style: 10 cycles')
plt.grid(True)
plt.tight_layout()
