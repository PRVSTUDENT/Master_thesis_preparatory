...
C ======================================================================
     ...
     4 NOEL,NPT,LAYER,KSPT,JSTEP,KINC)
      ...
      IF (NOEL .EQ. 278 .AND. NPT .EQ. 1) THEN
         IF (KINC .LE. 3) THEN
            WRITE(6,*) ''*** UMAT JUMP DEBUG ***''
            WRITE(6,*) ''NOEL='', NOEL, '' NPT='', NPT
            WRITE(6,*) ''KSTEP='', JSTEP(1), '' KINC='', KINC
            WRITE(6,*) ''TIME(1)='', TIME(1), '' TIME(2)='', TIME(2)
            WRITE(6,*) ''STATEV(1)='', STATEV(1), '' STATEV(8)='', STATEV(8),
     1                 '' STATEV(11)='', STATEV(11)
         END IF
      END IF
