...
csv_path = os.path.join(base, 'combined_asym_2cycle_hys.csv')
png_path = os.path.join(base, 'combined_asym_2cycle_hys.png')
...
plt.title('Combined hardening asymmetric: 2 cycles')
plt.grid(True)
plt.tight_layout()
